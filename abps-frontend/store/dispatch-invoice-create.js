  ...
  try {
    ...
    card.innerHTML = `
      ...
      <div style="display:flex; gap:10px; margin-top:14px;">
        ...
        <button class="nav-btn-styled" style="background:var(--accent); padding:8px 16px;" onclick="generateCpdiCheckingDraftOnly(${invoiceId})">📄 Generate Checking Draft</button>
      </div>
